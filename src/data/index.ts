...
export const translations = {
  en: {
    ...
    galleryImages: "Gallery Images (Max 4)",
    maxGalleryImages: "Maximum 4 gallery images allowed",
  ...
  ar: {
    ...
    galleryImages: "معرض الصور (الحد الأقصى 4)",
    maxGalleryImages: "الحد الأقصى 4 صورة لمعرض الصور",
